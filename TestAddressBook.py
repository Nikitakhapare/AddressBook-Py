...
class TestAddressBook(unittest.TestCase):
    ...
    def test_multipleContact(self):
        self.book.addContacts("DB","Bhonde","chandrapur","Chandrpur","mh",56566,1482415625,"nikikhapare@gmail.com")
        self.assertEqual(len(self.book.contact),3)
